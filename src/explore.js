...
export default function Explore() {
  ...
  return (
    ...
    <div className='firstdiv'>
      ...
      <Carousel.Item>
        <video
          ...
          src={Video} muted autoPlay loop
          alt="First slide" 
        />
        <Carousel.Caption>
          <h3 className='h3content'>Healthcare is not just a service, it is a fundamental right and a precious asset.</h3>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3 className='h3content'>Prevention is the key to a healthier future, empowering individuals to take control of their well-being.</h3>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3 className='h3content'>Patient care is the heart of a doctor's journey, where empathy and healing merge to nurture the body, mind, and soul.</h3>
   ...
   <p className='container-parafirst'>Our fundamental principles, beliefs and values <br/>that drive our business</p>
    ...
    <Card className='cards' >
      <Card.Body>
        ...
        <Card.Text>
        We always strive to do everything in our capacity to serve our patients better.
        </Card.Text>
    ...
    <Row >
      ...
      <Card.Body>
        ...
        <Card.Text>
        We are committed to offer the best healthcare at the most affordable price.
        </Card.Text>
    ...
    <div className='cardcontainer'>
        ...
        <p className='card-container-para-firstline'>We constantly strive to provide the best healthcare,<br/>with such an effort we have achieved,</p>
    <React.Fragment>
